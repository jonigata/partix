...
#include "partix_shapematching.hpp"
#include <string>
...
/*
    void match_shape_internal() {
        ...
        get_mesh()->calculate_Apq(Apq, current_center_);
...
*/
    ...
    void match_shape_internal() {
        ...
        typedef ShapeMatching<RetrieveCurrentPosition, Traits> SM;

        auto mesh = get_mesh();

        current_center_ = SM::calculate_center(mesh);
    ...
    void extract_rotation(const real_type A[9], quaternion<real_type>& q) {
...
public:
    ...
    void calculate_center() {
        current_center_ = get_mesh()->calculate_center();
    }
